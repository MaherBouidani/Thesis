...
describe('OrderCancelComponent', () => {
  ...
  let mockOrderCancelService;
  let mockDataService

  beforeEach(async(() => {

    mockOrderCancelService = sinon.createStubInstance(OrderCancelService);
    mockOrderCancelService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: OrderCancelService, useValue: mockOrderCancelService },
