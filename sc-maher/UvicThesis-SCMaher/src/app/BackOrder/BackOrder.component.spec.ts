...
describe('BackOrderComponent', () => {
  ...
  let mockBackOrderService;
  let mockDataService

  beforeEach(async(() => {

    mockBackOrderService = sinon.createStubInstance(BackOrderService);
    mockBackOrderService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: BackOrderService, useValue: mockBackOrderService },
