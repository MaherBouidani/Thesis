...
describe('DeliveringComponent', () => {
  ...
  let mockDeliveringService;
  let mockDataService

  beforeEach(async(() => {

    mockDeliveringService = sinon.createStubInstance(DeliveringService);
    mockDeliveringService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: DeliveringService, useValue: mockDeliveringService },
