...
describe('RequestPaymentComponent', () => {
  ...
  let mockRequestPaymentService;
  let mockDataService

  beforeEach(async(() => {

    mockRequestPaymentService = sinon.createStubInstance(RequestPaymentService);
    mockRequestPaymentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RequestPaymentService, useValue: mockRequestPaymentService },
